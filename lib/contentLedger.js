 ...
 * default; `angleChoice` (added 2026-09-01) is what Greg selected in the
 * angle dropdown ('', a specific angle id, or 'surprise'); `resolvedAngle`
 * is the angle actually used — same as `angleChoice` unless it was
 * 'surprise', in which case it's whichever specific angle Claude reported
 * choosing. All saved alongside the draft so reopening the page later still
