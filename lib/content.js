...
// truncation cutoff. Greg's actual goal is stricter -- short enough to
// qualify for Facebook's colored-background text option, which only appears
// for short, plain posts. That limit isn't documented anywhere and isn't
// verified against a real post yet -- ~100 is the figure most commonly cited
// for it, offered as a starting placeholder the same way the old 400-char
// guess was, not a confirmed number. Being short enough for the background
// option automatically satisfies the "See More" goal too, since it's the
// stricter of the two constraints.
const SHORT_FORM_MAX_CHARS = 100;
